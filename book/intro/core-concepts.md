---
layout: book
title: "Core Concepts: Things You Need to Know"
description: "How healthcare is delivered, and why controlled vocabularies (ICD-10, CPT, LOINC, RxNorm, SNOMED) are the foundation of every health dataset."
permalink: /book/intro/core-concepts/
redirect_from:
  - /book/intro/healthcare-delivery/
  - /book/intro/vocabularies/
---

## Healthcare 101

Healthcare delivery happens in distinct settings that serve different medical needs and generate different types of data. Outpatient care (also called ambulatory care) is how most people experience healthcare. This includes visits to doctor’s offices and urgent care clinics and even minor procedures like the removal of pre-cancerous lesions by a dermatologist. Inpatient care means admission to a hospital and almost always at least one overnight stay. Inpatient stays involve continuous monitoring, around-the-clock nursing care, and coordinated treatment from multiple specialists. Emergency departments handle acute crises regardless of ability to pay and serve as the gateway to inpatient admission for severely ill patients. Long-term care facilities (nursing homes, rehab centers) provide extended recovery or end-of-life care for patients who need more support than they can get at home but don't require intensive hospital resources.

## What is a Controlled Vocabulary?

If you're new to healthcare data, understanding controlled vocabularies is the single most important foundation you need to build before anything else makes sense. Healthcare vocabularies (*aka* terminologies or ontologies) are the fundamental language through which healthcare information is stored, exchanged, and analyzed. Without understanding these standardized code sets and terminologies, you'll struggle to interpret datasets, follow technical conversations, or conduct meaningful analysis.
...
1. Codes (Identifiers): These are unique alphanumeric identifiers assigned to each concept in the vocabulary. Codes provide a compact, unambiguous way to reference concepts in databases and transactions. Some vocabularies use meaningful codes (where the structure conveys information) while others use arbitrary identifiers. Here are some examples:

    - CPT 99213 — established patient office visit

    - ICD-10-CM E11.65 — type 2 diabetes with hyperglycemia

    - LOINC 2345-7 — serum glucose measurement

    - SNOMED CT 22298006 — myocardial infarction

    - RxNorm 197361 — amlodipine 5 mg oral tablet

1. Descriptions (Display Names): Human-readable text that explains what each code represents. A single code often has multiple descriptions for display suitable for different types of usage. For example, the procedure code 99213 has three different display names

    1. Short display name: "Office visit, established patient, level 3"

    1. Longer description: "Office or other outpatient visit for the evaluation and management of an established patient, which requires a medically appropriate history and/or examination and low level of medical decision making"

    1. Full official description: The complete CPT descriptor includes detailed criteria about the typical time spent (20-29 minutes), the nature of presenting problems (low to moderate severity), and specific documentation requirements.

1. Hierarchies (Parent-Child Relationships): Most vocabularies organize concepts into taxonomies where more specific concepts roll up to broader categories. These hierarchies enable data aggregation—you can query for all subtypes of a specific condition without enumerating every subtype.

For example, the ICD-10-CM code *S86.011D* represents a strain of the right achilles tendon. The first characters - *S86* - represent an injury of muscle, fascia, and tendon of the lower leg. The following characters - *.011* - localize that injury to the right achilles tendon. The final character - *D* - asserts that the diagnosis was observed at a subsequent encounter (i.e. not at the initial diagnosis). See below for a breakdown of this code.

<figure>
  <img src="{{ '/images/book/icd10-code-structure.svg' | relative_url }}" alt="ICD-10-CM code structure diagram for S86.011D showing category, etiology/anatomic site, and extension components">
